  ...
  return (
    <section id="pricing" className="py-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Outer Header Removed as requested */}
        ...
        <div className="max-w-4xl mx-auto bg-dark rounded-3xl overflow-hidden relative">
          ...
          <div className="flex flex-col md:flex-row">
            ...
            <div className="p-8 md:p-12 md:w-3/5 border-b md:border-b-0 ">
              {/* Changed h3 to h2 to serve as the main section header */}
              <h2 className="text-3xl font-bold text-light mb-2">Custom Landing Page</h2>
              ...
              <div className="space-y-6">
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-light font-bold text-lg">Mobile-First Design</h4>
                    <p className="text-light-dark text-sm">80% of your customers are on their phones. Your site will look perfect on every device, guaranteed.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-light font-bold text-lg">Speed Optimized</h4>
                    <p className="text-light-dark text-sm">I code from scratch (no bulky site builders). Your site loads instantly, which improves your Google Ranking.</p>
                  </div>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    <h4 className="text-light font-bold text-lg">100% Ownership</h4>
                    <p className="text-light-dark text-sm">Unlike marketing agencies that "rent" you a website, you own all the code and accounts. No hostage situations.</p>
                  </div>
                </div>
            ...
            <div className="p-8 md:p-12 md:w-2/5 flex flex-col justify-center bg-gray-900/50">
              <div className="text-center">
                <p className="text-light-dark font-medium mb-2">One-Time Design Fee</p>
                <div className="text-5xl font-extrabold text-light mb-2">$250</div>
