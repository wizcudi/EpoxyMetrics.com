...
export default function Hero() {
  return (
    <section className="flex flex-col items-center text-center px-6 py-10 max-w-4xl mx-auto">
      ...
      <p className="text-md sm:text-xl mb-10 max-w-2xl leading-relaxed">
        Most contractors lose 50% of their leads because their website looks outdated or doesn't work on mobile. I build <strong>high-converting landing pages</strong> that showcase your work and turn visitors into quotes.
      </p>
