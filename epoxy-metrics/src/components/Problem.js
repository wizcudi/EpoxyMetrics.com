      ...
      <div className="max-w-4xl mx-auto text-center">
        ...
        <div className="bg-light py-10 px-7.5 rounded-3xl shadow-lg border border-primary/10">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold mb-8">
            Stop Relying on "Word of Mouth" & Social DMs
          </h2>
          
          {/* Quote/Sub-head: Scaled to be readable but distinct */}
          <p className="text-xl sm:text-2xl leading-relaxed text-gray-800">
            You charge thousands for a garage floor, but your website looks like it was built in 2010. Homeowners judge your business by your website before they ever call you."
          </p>
